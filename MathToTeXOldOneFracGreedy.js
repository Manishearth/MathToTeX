...
//TODO: see TypedMath.preClean.sqrt()
...
/** Compiler function
* Converts TypedMath object into LaTeX recursivley
* 
* 
*/
...
TypedMath.preClean.fracs=function(text){
	if(text.split("/").length==2){ //Deals with stuff like "1/a+b". If there's only one fraction in a toke, the fraction will be greedy and swallow as much as possible
